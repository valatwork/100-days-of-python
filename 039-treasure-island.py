...
if direction == "left":
    ...
    if swim == "wait":
        ...
        if door == "yellow":
            ...
            print("The room is full of magical beasts. You get eaten. Game over.")
        elif door == "red":
            print("The room is on fire. You burn to death. Game over.")
        else:
            print("You chose a door that doesn't exist. Game over")
    else:
        print("You're attacked by a giant trout. Game over.")
else:
